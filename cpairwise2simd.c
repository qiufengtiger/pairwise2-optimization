...
static PyMethodDef cpairwise2MethodsSIMD[] = {
...

{
    ...
    return module;
#else
    (void) Py_InitModule3("cpairwise2simd", cpairwise2MethodsSIMD, cpairwise2__doc__);
#endif
}